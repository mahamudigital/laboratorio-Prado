...
class Concentrado2 extends StatefulWidget {
  Concentrado2(this.resultadocenvacas,this.resultado2,this.ganhoInvest,
  ...
  @override
  _Concentrado2State createState() => _Concentrado2State();
}

class _Concentrado2State extends State<Concentrado2> {
  @override
