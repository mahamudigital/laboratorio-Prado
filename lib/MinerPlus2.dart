...
class MinerPlus2 extends StatefulWidget {

  MinerPlus2(this.resultadocenvacas,this.resultado2,this.ganhoInvest,
      this.investimentobezerrocenvacas,this.ganhoBezerrocenvacas,this._plantel,
      this.resultado,this.investbezerro,this.ganhoresultado2,this.ganhoBezerroprodutor);
  ...
  @override
  _MinerPlus2State createState() => _MinerPlus2State();
}

class _MinerPlus2State extends State<MinerPlus2> {
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child:
                Text("Ganho   R\$  ${widget.ganhoresultado2}                    Bezerros ${widget.ganhoBezerroprodutor}",
                    style: TextStyle(
                      color: Colors.white,
                    )
                ),
